...
<ul id="nav">
  <li><span>OTU=></span></li>
  <li><a href="#" id="base" name="navitem"  class="current" onclick="javascript:toUrl('otubi');">基本信息</a></li>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
   ...
   <td colspan="4" align="center">
    <input class="button white medium" type="button" value="刷新" onclick="window.location.href('otubi.asp');" name="refresh"/>
